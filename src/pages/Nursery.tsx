  ...
  return (
    <div className="bg-green-50 py-12 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Page Header */}
        <h1 className="text-4xl font-bold text-center text-green-600 mb-8">Welcome to Our Nursery Program</h1>
        ...
        <section className="mb-12">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-6 md:mb-0">
              <img
                src="../assets/nursery-image.jpg"
                alt="Nursery"
                className="rounded-lg shadow-lg w-full h-72 object-cover"
              />
            </div>
            <div className="md:w-1/2 md:pl-12">
              <h2 className="text-3xl font-semibold text-green-600 mb-4">A Nurturing Environment for Young Learners</h2>
        ...
        <section className="mb-12">
          <h3 className="text-2xl font-semibold text-green-600 mb-6 text-center">Key Features of Our Nursery Program</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              <h4 className="text-xl font-semibold text-green-600 mb-4">Experienced Educators</h4>
              <p className="text-gray-700">
                Our team of experienced nursery teachers is passionate about nurturing young minds and fostering a love of learning.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              <h4 className="text-xl font-semibold text-green-600 mb-4">Play-Based Curriculum</h4>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              <h4 className="text-xl font-semibold text-green-600 mb-4">Safe and Secure Environment</h4>
              <p className="text-gray-700">
        ...
        {/* Section: Activities */}
        <section className="mb-12">
          <h3 className="text-2xl font-semibold text-green-600 mb-6 text-center">Fun and Engaging Activities</h3>
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-3 max-w-2xl mx-auto">
        ...
        <div className="text-center">
          <a
            href="/contact"
            className="bg-green-600 text-white py-3 px-6 rounded hover:bg-green-700 transition duration-300"
          >
