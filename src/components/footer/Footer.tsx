        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-4 md:mb-0">
            ...
            <ul className="text-sm">
              ...
              <li><a href="#contact" className="hover:underline">Gallery</a></li>
              <li><a href="#contact" className="hover:underline">News  &  Events</a></li>
              <li><a href="#contact" className="hover:underline">Sections</a></li>
          ...
          <div className="w-full md:w-1/4 mb-4 md:mb-0">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-xl hover:text-green-700">
                <FaWhatsapp />
              </a>
            </div>
          </div>
