...
const Home = () => {
  ...
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="absolute inset-0 bg-black/60"></div>
      {/* Content */}
      <div className="relative z-10 h-full w-full flex flex-col justify-center items-center pl-8 space-y-8 md:-[50%]">
      ...
      <div className="flex">
        ...
        <div className="relative w-1/3 h-[360px] p-4 flex flex-col justify-center items-center overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center space-y-4">
            ...
            <h1 className="mt-2 text-white">Conducive Learning Environment</h1>
          </div>
        </div>
